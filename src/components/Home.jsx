                    ...
                    <div className="px-0">
                      <div className="flex flex-col">
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="text-2xl font-bold transition-all duration-300 transform hover:scale-105 hover:font-extrabold hover:text-black dark:hover:text-white origin-center"
                        >
                          {experience.company}
                        </a>
                        <span className="text-base text-gray-500">
